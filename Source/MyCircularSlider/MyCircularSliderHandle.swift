...
public enum MYCircularSliderHandleType: Int, RawRepresentable {
    case smallCircle = 0,
    mediumCircle,
    largeCircle,
...
@IBDesignable
public class MYCircularSliderHandle: CALayer {
    ...
    private var slider: MYCircularSlider {
        return delegate as! MYCircularSlider
    }
    ...
    internal var handleType: MYCircularSliderHandleType = .largeCircle {
        didSet {
            setNeedsDisplay()
        }
    }
